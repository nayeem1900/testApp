                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                @foreach ($actions as $action)
                                                    <th scope="col"><input type="checkbox" id="allCheck_{{ $action->id }}" class="allCheck_{{ $action->id }}"> {{ $action->name }} </th>
                                                @endforeach                                           
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @php $check = App\Http\Controllers\MenuActivityController::actionCheck($menu_act->id, $action->id) @endphp
                                                        <td>
                                                            @if($check)
                                                                <input type="checkbox" id="check_{{ $action->id }}" class="check_{{ $action->id }}" name="action[{{ $menu_act->id }}][{{ $action->id }}]" value={{ $action->id }}>
                                                            @else
